...
public class Drivetrain extends SubsystemBase {
    ...
    public Drivetrain(
        ...
        // do a ton of shit i don't understand alvin pls explain
    ...
    public void periodic() {
        ...
        for (int i = 0; i < sampleCount; i++) {
            ...
            if (acceptMeasurement) {
                if (gyroInputs.isConnected) rawGyroRotation = gyroInputs.odometryYawPositions[i];
                else {
